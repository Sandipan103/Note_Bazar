...
const sendVerificationMail = async (email, otp) => {
  try {
    const title = "Verification mail from Note_Bazar";
    const body = `
    <div style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px; text-align: center;">
      <h1 style="color: #4CAF50; font-size: 28px; margin-bottom: 20px;">Note_Bazar</h1>
      ...
      <div style="background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        ...
        <p style="color: #555; font-size: 16px; margin-bottom: 20px;">Please use this OTP to verify your email and continue the process.</p>
      </div>
      <p style="color: #888; font-size: 14px; margin-top: 20px;">Note_Bazar Team</p>
    </div>
    `;
